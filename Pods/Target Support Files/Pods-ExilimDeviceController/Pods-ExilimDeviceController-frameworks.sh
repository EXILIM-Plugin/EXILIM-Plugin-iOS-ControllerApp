...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/DeviceConnectExilimPlugin/DeviceConnectExilimPlugin.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxAutomaton/RxAutomaton.framework"
